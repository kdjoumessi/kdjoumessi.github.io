...
## Latest News
- __August 2026__ - <span style="color:red"> Five papers accepted at MICCAI-Workshops </span> 
     - <i> <a href="https://arxiv.org/abs/2603.18846"> Towards Interpretable Foundation Models for Retinal Fundus Images </a> </i>, accepted for oral presentation at the <a href="https://imimic-workshop.com/"> IMIMIC workshop </a>
    - <i> <a href="https://openreview.net/forum?id=EfEw9x5MV1"> Beyond Predictive Fairness: Quantifying Attribution Consistency Across Demographic Groups in Diabetic Retinopathy Screening </a> </i>, accepted at the <a href="https://faimi-workshop.github.io/"> FAIMI workshop </a>
    - <i> <a href="https://arxiv.org/abs/2608.18774"> MIFR: A Modality-Invariant and Fair Representation Framework for Skin Disease Classification </a> </i>, accepted at the <a href="https://africai.org/africai-2026/"> AFRICAI workshop </a>
    - <i> <a href="https://africai.org/africai-2026/"> Evaluating the Deployment Readiness of AI in an African Clinical Context </a> </i>, accepted at the <a href="https://africai.org/africai-2026/"> AFRICAI workshop </a>
    - <i> <a href="https://mirasol.rise-miccai.org/"> Characterizing Domain Shift in Glioma Segmentation Between Global North and African MRI Datasets </a> </i>, accepted at the <a href="https://mirasol.rise-miccai.org/"> MIRASOL workshop </a>
    
- __May 2026__ - <span style="color:red"> New accepted paper</span> - Our short paper [TTE-CAM: Built-in Class Activation Maps for Test-Time Explainability in Pretrained Black-Box CNNs](https://arxiv.org/abs/2603.26885) has been accepted at [MIDL 2026](https://2026.midl.io/). In this work, we propose a plug-and-play test-time framework for enhancing the explainability of standard black-box CNNs without requiring any retraining of the underlying network, analogous to post-hoc explanation methods.
- __April 2026__ - <span style="color:red"> Introduction to interpretable ML at AIMS-RIC </span> - I taught an introductory course on interpretable machine learning at the [Training School: Foundational Methods in Data Science 2026.](https://trainingschool.aimsric.org/)
- __February 2026__ - <span style="color:red"> New accepted paper</span> - Our paper [SoftCAM: Making black box models self-explainable for high-stakes decisions](https://openreview.net/forum?id=3v1rKkPvuU) has been accepted at [MIDL 2026](https://2026.midl.io/). In this work, we present __SoftCAM__, a simple yet effective method to transform black-box CNNs into inherently self-explainable models, with extensive validation on medical imaging datasets. Unlike post-hoc methods, Soft-CAM modifies the network architecture itself: we remove the global average pooling layer and replace the fully connected classifier with a spatially aware class-evidence layer—implemented via a convolutional layer. This design preserves spatial information and produces class-specific evidence maps that directly support the model’s predictions. We further enhance interpretability by applying ElasticNet regularization on the evidence maps to refine the explanations. Quantitative comparisons show that Soft-CAM outperforms existing class activation map (CAM) methods, all without compromising classification performance.
...
- __Jun 2024__ - Two papers accepted at MICCAI 2024
    - <i> <a href="https://link.springer.com/chapter/10.1007/978-3-031-72117-5_67"> This actually looks like that: Proto-BagNets for local and global interpretability-by-design </a> </i>
    - <i> <a href="https://link.springer.com/chapter/10.1007/978-3-031-72117-5_47"> Interpretable-by-design Deep Survival Analysis for Disease Progression Modeling </a> </i>
...
## Reviewing
- [MICCAI](https://miccai.org/) (4+4+1): 2024, 2025, 2026
...
- [Plos Digital Health](https://journals.plos.org/digitalhealth/) (1): 2024
